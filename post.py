...
class PostControl(Resource):
    ...
    def put(self):  # 게시글 수정
        ...
        past_likes = mongodb.find_one(query={"_id": ObjectId(content_id)}, collection_name=board_type, projection_key={"_id":False, "likes":1})
        ...
        if result.raw_result["n"] == 1:
            ...
            if (past_likes < 10) and (modified_post["likes"] == 10) :
                ...
                mongodb.delete_one(query={"_id": ObjectId(content_id)}, collection_name="hot_board")
