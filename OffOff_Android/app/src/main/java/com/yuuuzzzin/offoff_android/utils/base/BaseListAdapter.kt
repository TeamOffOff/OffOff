...
abstract class BaseListAdapter<T : Identifiable, VB : ViewDataBinding>(
    private val itemClick: onItemClick<T>? = null,
    @LayoutRes private val layoutRes: Int
) : ListAdapter<T, BaseListAdapter.BaseViewHolder<T>>(object : DiffUtil.ItemCallback<T>() {
    /*
